...
public class ServletComentario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(op){
            case "GetComentario":{
                int comentarioID=(int)request.getAttribute("comentarioID");
                Comentario comentario=control.getComentario(comentarioID);
                request.setAttribute("comentarioDB", comentario);
                break;
            }
            case "AddComentario":{
                int recetaID=(int)request.getAttribute("recetaID");
                Comentario comentario=(Comentario)request.getAttribute("comentario");
                control.addComentario(recetaID, comentario);
            }
        }
    }
